...
import com.example.androidsampletest.ui.viewmodel.UserViewModel
import com.example.androidsampletest.ui.viewmodel.UserViewModelFactory
...
class FirstFragment : Fragment(), KodeinAware {
    ...
    override fun onCreateView(
        ...
        var userViewModel: UserViewModel = ViewModelProvider(this, factory).get(UserViewModel::class.java)
        getUserInfo(userViewModel)
        return view
    }
    ...
    fun getUserInfo(userViewModel: UserViewModel): List<UserInfo> {

        var userInfoResponse: List<UserInfo> = ArrayList()
        lifecycleScope.launch {
            try {
                userInfoResponse = userViewModel.getUserInfo()
